...
//database setting
const db_name = path.join(__dirname, "post.db"); //sqlite3 database file name  --__dirname 실행되는 디렉토리 정보
...
app.get("/posts", (req, res)=>{
    ...
    //page:1, offset:0, page:2, pffset:5, page:3. offset:10
    ...
    db.all(sql, [limit, offset], (err, rows)=>{
        ...
        db.get(total_sql, (err1, row)=>{
            ...
            res.status(200).json({item:rows, currentPage:page, totalPages:totalPages});
        })
...
//body -> raw -> json {"title":"updated title", "content":"updated content"}
